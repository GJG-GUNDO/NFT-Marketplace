...
export const NFTMarketplaceProvider = ({ children }) => {
    ...
    if (file) {
      try {
        ...
        const response = await axios({
          ...
          data: formData,
          headers: {
            pinata_api_key: "547faae2d697a4a418cd",
            pinata_secret_api_key:
              "0514a9dc16cbd9165b302efb0e181a7416b8b7a751e7b075d4be014afbd8993b",
  ...
  const fetchNFTs = async () => {
    try {
      if (currentAccount) {
        ...
        ("https://polygon-amoy.g.alchemy.com/v2/a-Mde9jCnqWRWwhamLyVaWjYeqZrgGZG");
  ...
  const fetchMyNFTsOrListedNFTs = async (type) => {
    try {
      ...
      setOpenError(true);
      console.log(error, "Error while fetching listed NFTs")
    }
  };
